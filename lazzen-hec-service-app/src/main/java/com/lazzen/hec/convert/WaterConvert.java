...
public class WaterConvert extends Convert {
    private final static Pattern pattern = Pattern.compile("^(" + BusinessConstants.Water.SYB_FORWARD_TOTAL + "|"
        + BusinessConstants.Water.SYB_REVERSE_TOTAL + "|" + BusinessConstants.Water.SYB_MOMENT + ")(\\d+)$");
